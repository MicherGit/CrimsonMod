...
package gg.zetabloox.thecrimson.entity;
...
public class HerobrineEntity extends InfinitepowerupdModElements.ModElement {
	public static EntityType entity = null;
	public HerobrineEntity(InfinitepowerupdModElements instance) {
		super(instance, 146);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711732, -1, new Item.Properties().group(CrimsontaleItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("infinitepowerupd:empty_plains").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("infinitepowerupd:textures/herobrine_1.png");
					}
				};
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 80;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(VoidShadowSwordItem.block, (int) (1)));
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 50, true));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(VoidShadowIngotItem.block, (int) (1)));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				HerobrineEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		private final ServerBossInfo bossInfo = new ServerBossInfo(this.getDisplayName(), BossInfo.Color.BLUE, BossInfo.Overlay.NOTCHED_12);
		@Override
