...
public class HerobrineEntity extends InfinitepowerModElements.ModElement {
	public static EntityType entity = null;
	public HerobrineEntity(InfinitepowerModElements instance) {
		super(instance, 146);
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("infinitepower:empty_plains")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("infinitepower:textures/herobrine_1.png");
				}
			};
