...
import gg.zetabloox.thecrimson.item.SapphireGemItem;
import gg.zetabloox.thecrimson.InfinitepowerupdModElements;

@InfinitepowerupdModElements.ModElement.Tag
public class SapphireOreBlock extends InfinitepowerupdModElements.ModElement {
	@ObjectHolder("infinitepowerupd:sapphire_ore")
	public static final Block block = null;
	public SapphireOreBlock(InfinitepowerupdModElements instance) {
		super(instance, 98);
