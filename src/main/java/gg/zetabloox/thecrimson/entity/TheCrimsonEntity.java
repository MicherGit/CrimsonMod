...
public class TheCrimsonEntity extends InfinitepowerModElements.ModElement {
	...
	public TheCrimsonEntity(InfinitepowerModElements instance) {
		super(instance, 152);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(101);
			...
			this.getAttribute(SharedMonsterAttributes.FLYING_SPEED).setBaseValue(5);
		}
