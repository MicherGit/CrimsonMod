...
public class SapphireOreBlock extends InfinitepowerModElements.ModElement {
	@ObjectHolder("infinitepower:sapphire_ore")
	public static final Block block = null;
	public SapphireOreBlock(InfinitepowerModElements instance) {
		super(instance, 98);
	}
