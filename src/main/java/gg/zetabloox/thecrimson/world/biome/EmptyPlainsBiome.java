...
public class EmptyPlainsBiome extends InfinitepowerupdModElements.ModElement {
	public static Biome biome;
	public EmptyPlainsBiome(InfinitepowerupdModElements instance) {
		super(instance, 145);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(VoidblockBlock.block.getDefaultState(),
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.PLAINS).depth(0.1f).scale(1f).temperature(2f)
						.downfall(0.1f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("infinitepowerupd:empty_plains"));
			}
		}
	}
	@Override
